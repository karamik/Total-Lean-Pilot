Да, отличный ход — арбитражники это идеальная первая аудитория. Давай доработаю `docs/API.md` — добавлю реальные метрики, уберу фейковые адреса (Omnichain Router `0x000...A1` выглядит как заглушка), и сделаю код production-ready.
